...
def get_config():
    ...
    parser.add_argument('--data_dir', type=str, default='/root/lanyun-tmp/CelebA/', help='data directory')
    parser.add_argument('--model_type', type=str, default='model', help='Model type or name')
    ...
    # Prior settings
    parser.add_argument('--prior', type=str, default='linscm', choices=['scm_flow', 'uniform', 'linscm', 'nlrscm'],
