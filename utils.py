...
def make_dataloader(args):
    ...
    if args.dataset == 'celeba':
        ...
        test_set = datasets.CelebA(args.data_dir, split='test', download=False, transform=trans_f)
        test_loader = torch.utils.data.DataLoader(test_set, batch_size=args.batch_size, shuffle=True, pin_memory=False,
                                                   drop_last=True, num_workers=4)
